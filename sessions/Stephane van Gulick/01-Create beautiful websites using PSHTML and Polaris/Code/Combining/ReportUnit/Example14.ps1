<#
    If you are interested in this example, you might want to have a look at PesterLover, which contains the following reports, but in an easy to use format.
#>
...
$FilePath = (resolve-path .\TestREsults.Json).Path
